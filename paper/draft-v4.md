...
### Large-genome stress tests

Historical stress tests produced packages for assemblies up to 34.56 GB (Table 2). The 28.21-GB *Ambystoma mexicanum* test did not produce a package and ended after 29 min 23 s. The retained GitHub Actions annotation reports that the runner had no space left on the device. The large-genome tests used different workflow revisions, including revisions before intermediate-file cleanup. They therefore do not support a causal comparison of genome size or assembly contiguity. A controlled benchmark now tests 16 NCBI assemblies with one workflow revision and records build-stage resource use.
...
|---|---|---:|---:|---|---:|---:|
| *Triticum aestivum* | IWGSC RefSeq v2.1 | 14.57 GB | 91,588 scaffolds | Built | 12:05 | Not recorded |
| *Pinus taeda* | Ptaeda2.0 | 22.10 GB | 1,760,464 scaffolds | Built | 34:18 | Not recorded |
| *Ambystoma mexicanum* | AmbMex60DD | 28.21 GB | 27,157 scaffolds | No package, runner disk exhausted | 29:23 | Not recorded |
...
**Figure 4. Controlled large-genome benchmark.** Results for 16 NCBI assemblies showing total sequence length, scaffold count, scaffold N50, actual FASTA record count, build outcome, elapsed time and peak resource use.
